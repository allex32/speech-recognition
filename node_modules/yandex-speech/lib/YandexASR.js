...
var YandexASR = function(options, callback){
    ...
    var init = function(options){        
        ...
        file['filetype'] = (options['filetype']) ? options['filetype'] : 'audio/x-wav';
    }(options);    

    var full_url = yandex_asr_url + qs.stringify(params);


    var check_file_exist= function(filepath){
    ...
    if(check_file_exist(file['filepath'])) {
    ...
    else callback('file is not exist');
};
